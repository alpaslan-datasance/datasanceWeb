...
function sliderTwo() {
    ...
    const [customCardSliderTwoState, setcustomCardSliderTwoState] = React.useState<any[]>()

    React.useEffect(() => {
        const cards = [
            {
                name: "Slider Two First item",
                content: <>
                    <div className='w-full flex justify-center h-42' style={{ backgroundColor: "#0B1522" }}>
                        <div className='container'>
                            <div className='grid lg:text-grid-cols-12 xl:text-grid-cols-12 2xl:grid-cols-12 gap-3 xl:m-8 2xl:m-8 '>
            ...
            {
                name: "Slider Two Third item",
                content: <>
                    <div className='w-full flex justify-center'>
                        <div className='container h-42'>
                            <div className='grid lg:text-grid-cols-2 xl:text-grid-cols-2 2xl:grid-cols-2 bg-white gap-3 m-8 '>
                                <div className=''>
                                    <div className='text-start text-black font-bold text-xl'>Cloud centric is not Intelligence centric</div>
                                    <div className='text-start text-black text-lg mt-4'>Cloud brings lots of improvement for managing datacenter operations, and developing software. However, modern Artificial Intelligence use cases requires sub-millisecond latencies which could not be provided by just-Cloud approach. That is the reason why Edge is the mega trend and building proper Edge infrasture is the first thing inside technology leaders agenda.</div>
        ...
        setcustomCardSliderTwoState(cards)
    }, [])
